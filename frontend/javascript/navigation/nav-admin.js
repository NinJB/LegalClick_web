/*******************************************************************************************************************/
/*Javascript for admin navigation bar*/
/*******************************************************************************************************************/
  ...
  template: `
    <div class="layout">
      ...
      <aside class="side-nav">
        <nav>
          <a href="/html/admins/settings.html" class="chosen-dashboard" data-icon="settings">
            <div class="icon-wrapper">
              <img src="/images/settings-gray.png" class="icon-img" />

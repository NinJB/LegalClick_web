    ...
    computed: {
        filteredLawyers() {
            ...
            if (this.activeFilter === 'Requests') {
                return filtered.filter(lawyer => lawyer.attorney_category === 'Private' && lawyer.account_status === 'Request');
            } else if (this.activeFilter === 'Activated') {
                return filtered.filter(lawyer => lawyer.attorney_category === 'Private' && lawyer.account_status === 'Activated');
            } else if (this.activeFilter === 'Rejected') {
                return filtered.filter(lawyer => lawyer.attorney_category === 'Private' && lawyer.account_status === 'Rejected');
            } else if (this.activeFilter === 'Deactivated') {
                return filtered.filter(lawyer => lawyer.attorney_category === 'Private' && lawyer.account_status === 'Deactivated');
            } else {
                return filtered;
            }
        },
        requestsCount() {
            return this.lawyers.filter(lawyer =>
                ...
                lawyer.attorney_category === 'Private'
            ).length;
        },
        activatedCount() {
            return this.lawyers.filter(lawyer =>

const Password = Vue.createApp({
    ...
    methods: {
      async changePassword() {
        ...
        try {
          const response = await fetch(`${window.API_BASE_URL}/api/change-password-admin/${this.roleId}`, {
            method: 'POST',
            headers: {
      ...
      <div class="profile__container">
        <section class="profile__information">
          ...
          <div class="profile__options">
            <a href="/html/admins/profile.html"><button>Profile Information</button></a>

...
createApp({
  ...
  methods: {
    ...
    async fetchServices() {
      const baseUrl = window.API_BASE_URL;
      const res = await fetch(`${baseUrl}/lawyer/${this.roleId}/services`, { headers: { 'Authorization': 'Bearer ' + sessionStorage.getItem('jwt') } });
    ...
    async saveSpecializations() {
      const baseUrl = window.API_BASE_URL;
      const res = await fetch(`${baseUrl}/lawyer/${this.roleId}/specializations`, {
        method: 'POST',
    ...
    async saveServices() {
      const baseUrl = window.API_BASE_URL;
      const res = await fetch(`${baseUrl}/lawyer/${this.roleId}/services`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + sessionStorage.getItem('jwt') },
